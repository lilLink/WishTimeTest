...
public class FillWishFormWithEmptyPrice implements Task {

    private final Wish wish;

    public FillWishFormWithEmptyPrice(Wish wish) {
        this.wish = wish;
    }

    public static Performable fillForm(Wish wish) {
        return Instrumented.instanceOf(FillWishFormWithEmptyPrice.class).withProperties(wish);
    }
