...
public class FillWishFormWithEmptyLink implements Task {

    private final Wish wish;

    public FillWishFormWithEmptyLink(Wish wish) {
        this.wish = wish;
    }

    public static Performable fillForm(Wish wish) {
        return Instrumented.instanceOf(FillWishFormWithEmptyLink.class).withProperties(wish);
    }
