...
public class FillWishForm implements Task {

    private final Wish wish;

    public FillWishForm(Wish wish) {
        this.wish = wish;
    }

    public static Performable fillForm(Wish wish) {
        return Instrumented.instanceOf(FillWishForm.class).withProperties(wish);
    }
    ...
    public <T extends Actor> void performAs(T user) {
        user.attemptsTo(
                ...
                Click.on(WishFormPage.saveWish())
        );
    }
