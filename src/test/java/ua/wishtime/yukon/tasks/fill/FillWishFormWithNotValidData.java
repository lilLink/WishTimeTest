...
public class FillWishFormWithNotValidData implements Task {

    private final Wish wish;

    public FillWishFormWithNotValidData(Wish wish) {
        this.wish = wish;
    }

    public static Performable fillForm(Wish wish) {
        return Instrumented.instanceOf(FillWishFormWithNotValidData.class).withProperties(wish);
    }
