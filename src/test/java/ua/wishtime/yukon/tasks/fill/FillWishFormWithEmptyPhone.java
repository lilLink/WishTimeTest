...
public class FillWishFormWithEmptyPhone implements Task {

    private final Wish wish;

    public FillWishFormWithEmptyPhone(Wish wish) {
        this.wish = wish;
    }

    public static Performable fillForm(Wish wish) {
        return Instrumented.instanceOf(FillWishFormWithEmptyPhone.class).withProperties(wish);
    }
